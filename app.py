...
lineaccesstoken = 'B3X43tu+5gZUwpPSdJMKXjX86PCEbVCH4Uwrf1F0TxkP3pS7hSLC2Srimfie65SEc66YMNeZHAUrUye5JcXJvo6a3BiyF63RWiczAadcMetjcoyiT8Xr249UxlKVfl9g9hKmAOJzIPi9U9q1fiuMzAdB04t89/1O/w1cDnyilFU='
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
           ...
           line_bot_api.reply_message(rtoken, replyObj)
            ...
            replyObj = TextSendMessage(text="ได้ยิน")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "แบตจะหมด") :
            replyObj = TextSendMessage(text="ชาร์จดิ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ง่วงป่ะ") :
            replyObj = TextSendMessage(text="ง่วง")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers 
            json_headers = ({k:v for k, v in headers.items()}) 
            json_headers.update({'Host':'bots.dialogflow.com'}) 
            url = ""https://dialogflow.cloud.google.com/v1/integrations/line/webhook/47832df3-f294-495a-abdb-c16a00b3e853 
